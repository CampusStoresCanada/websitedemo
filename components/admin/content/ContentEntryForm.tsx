    ...
    >
      ...
      <div>
        ...
        <input
          ...
          required
          className="w-full h-10 px-3 rounded-lg border border-[#E5E5E5] text-sm focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent"
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-3 py-2 rounded-lg border border-[#E5E5E5] text-sm focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent resize-none"
      ...
      <div>
        ...
        <input
          ...
          className="w-24 h-10 px-3 rounded-lg border border-[#E5E5E5] text-sm focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent"
        />
      </div>
