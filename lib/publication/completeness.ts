...
export const COMPLETENESS_ORG_COLUMNS =
  "id, name, slug, public_code, type, city, province, website, phone, email, public_contact_confirmed_at, fte, logo_url, company_description, primary_category, " +
...
export type OrgCompletenessSource = {
  ...
  /** Permanent code behind the printed QR. Not scored — it is always present. */
  public_code?: string | null;
  /** Carried for the publication's listing shapes; not part of completeness. */
  type?: string | null;
  city?: string | null;
  province?: string | null;
  website?: string | null;
  phone?: string | null;
  /** Public-record contact, publishable only once affirmed. */
  email?: string | null;
